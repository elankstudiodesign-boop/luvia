    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="relative h-[60vh] w-full overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center text-center text-white px-4">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-display font-bold mb-6 tracking-wide drop-shadow-lg">VỀ LAVIA</h1>
            <p className="text-lg md:text-xl font-light tracking-wider uppercase drop-shadow-md">Kiến tạo phong cách sống thượng lưu</p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20 px-6 md:px-12 max-w-5xl mx-auto">
        ...
        >
          <h2 className="text-3xl font-display font-bold text-lavia-blue mb-8">Câu Chuyện Của Chúng Tôi</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-20">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <h3 className="text-2xl font-display font-bold text-lavia-blue mb-4">Tầm Nhìn</h3>
          ...
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <h3 className="text-2xl font-display font-bold text-lavia-blue mb-4">Sứ Mệnh</h3>
            <p className="text-gray-600 leading-relaxed">
        ...
        >
          <h3 className="text-2xl font-display font-bold text-lavia-blue mb-6">Giá Trị Cốt Lõi</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <h4 className="font-bold text-lg mb-2 text-lavia-mint">Tận Tâm</h4>
              <p className="text-sm text-gray-600">Luôn đặt khách hàng làm trọng tâm trong mọi suy nghĩ và hành động.</p>
            </div>
            <div>
              <h4 className="font-bold text-lg mb-2 text-lavia-mint">Uy Tín</h4>
              <p className="text-sm text-gray-600">Cam kết thực hiện đúng lời hứa và đảm bảo chất lượng dịch vụ tốt nhất.</p>
            </div>
            <div>
              <h4 className="font-bold text-lg mb-2 text-lavia-mint">Đẳng Cấp</h4>
