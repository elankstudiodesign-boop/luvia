    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="relative h-[60vh] w-full overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center text-center text-white px-4">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-display font-bold mb-6 tracking-wide drop-shadow-lg">PHÁP LÝ & QUYỀN RIÊNG TƯ</h1>
            <p className="text-lg md:text-xl font-light tracking-wider uppercase drop-shadow-md">Cam kết bảo mật và minh bạch</p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20 px-6 md:px-12 max-w-5xl mx-auto">
        <motion.div
          ...
          className="mb-16"
        >
          <h2 className="text-3xl font-display font-bold text-lavia-blue mb-8">Chính Sách Bảo Mật</h2>
        ...
        <motion.div
          ...
          className="mb-16"
        >
          <h2 className="text-3xl font-display font-bold text-lavia-blue mb-8">Điều Khoản Sử Dụng</h2>
          <p className="text-gray-600 leading-relaxed text-lg mb-6">
        ...
        >
          <h3 className="text-2xl font-display font-bold text-lavia-blue mb-6">Liên Hệ Pháp Lý</h3>
          ...
          <ul className="text-gray-600 space-y-2">
            <li><strong>Email:</strong> legal@lavia.vn</li>
