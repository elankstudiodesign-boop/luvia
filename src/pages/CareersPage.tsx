    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="relative h-[60vh] w-full overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center text-center text-white px-4">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-display font-bold mb-6 tracking-wide drop-shadow-lg">TUYỂN DỤNG</h1>
            <p className="text-lg md:text-xl font-light tracking-wider uppercase drop-shadow-md">Gia nhập đội ngũ LAVIA</p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20 px-6 md:px-12 max-w-5xl mx-auto">
        ...
        >
          <h2 className="text-3xl font-display font-bold text-lavia-blue mb-8">Tại Sao Chọn LAVIA?</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-20">
          ...
          >
            <h3 className="text-2xl font-display font-bold text-lavia-blue mb-4">Môi Trường Chuyên Nghiệp</h3>
          ...
          <motion.div
            ...
            className="bg-gray-50 p-8 rounded-xl"
          >
            <h3 className="text-2xl font-display font-bold text-lavia-blue mb-4">Phúc Lợi Hấp Dẫn</h3>
            <p className="text-gray-600 leading-relaxed">
        ...
        >
          <h3 className="text-2xl font-display font-bold text-lavia-blue mb-6">Vị Trí Đang Tuyển Dụng</h3>
          ...
          <a 
            href="mailto:tuyendung@lavia.vn" 
            className="inline-block px-8 py-3 bg-lavia-blue text-white font-bold rounded-full hover:bg-lavia-mint transition-colors"
          >
            Gửi CV Ngay
          </a>
        </motion.div>
